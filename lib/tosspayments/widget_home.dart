...
import 'package:cafeplatform/tosspayments/config.dart';
import 'package:cafeplatform/tosspayments/payment_widget_example_page.dart';
...
class WidgetHomeState extends State<WidgetHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('toss payments 결제 테스트ㅇㅇ'),
        centerTitle: true,
            ...
            children: [
              ...
              DropdownButtonFormField<Currency>(
                ...
                items: Currency.values
                    .map<DropdownMenuItem<Currency>>((Currency c) {
